            ...
            <div className='py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12'>
              ...
              >
                <div>
                  ...
                  />
                  <SelectField
                    name={schema.fields.species.name}
                    handleChange={formik.handleChange}
                    handleBlur={formik.handleBlur}
                    value={formik.values[schema.fields.species.name]}
                    options={schema.fields.species.attributes.options}
                    className={schema.classes.input}
                  />
                  <ErrorField
                    error={formik.errors[schema.fields.species.name]}
                    touched={formik.touched[schema.fields.species.name]}
                  />
                </div>
                ...
                <div>
                  ...
                  <TextField
                    ...
                    value={
                      formik.values[
                        schema.fields.lost_found_date.attributes.name
                      ]
                    }
                  />
                  <ErrorField
                ...
                <div className='sm:col-span-2'>
                  ...
                  <ErrorField
                    ...
                    touched={
                      formik.touched[schema.fields.address.attributes.name]
                    }
                  />
                </div>
                ...
                <div className='sm:col-span-2'>
                  ...
                  <TextField
                    ...
                    handleBlur={formik.handleBlur}
                    value={
                      formik.values[schema.fields.crossroads.attributes.name]
                    }
                  />
                  <ErrorField
                    error={
                      formik.errors[schema.fields.crossroads.attributes.name]
                    }
                    touched={
                      formik.touched[schema.fields.crossroads.attributes.name]
                    }
                  />
                </div>
                ...
                <div className='sm:col-span-2'>
                  ...
                  <ErrorField
                    ...
                    touched={
                      formik.touched[schema.fields.comment.attributes.name]
                    }
                  />
                </div>
