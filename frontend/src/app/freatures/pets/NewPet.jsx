...
export default function NewPetForm() {
  ...
  return (
    <section id='new_pet' araia-aria-label='NewPetForm'>
      <Container className=' mx-10 rounded-3xl bg-orange-50'>
        <div className='mx-auto max-w-7xl  py-16 px-4 sm:py-24 sm:px-6 lg:px-8'>
          <div className='relative rounded-xl shadow-xl md:rounded-3xl'>
            <h2 className='sr-only'>Pet Information</h2>

            <div className='grid grid-cols-1 md:grid-cols-3'>
              {/* ---------------------------------------------------- */}
              {/* relative overflow-hidden bg-csOrange py-10 px-6 sm:px-10 md:rounded-tl-xl md:rounded-bl-xl xl:p-12 */}
              <div className='relative overflow-hidden md:p-5'>
                <div className='flex flex-col justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6'>
                  <div className='_space-y-1 text-center opacity-80'>
                    <Image
                      ...
                      alt='dog-placeholder'
                      className='wh-full h-full'
                    />
                  </div>
                  <button className='rounded-lg border-orange-500 bg-slate-200 p-2'>
                    <svg
              ...
              {/* ---------------------------------------------------- */}
              <div className='bg-white py-10 px-6 sm:px-10 md:col-span-2 xl:p-12'>
                ...
                >
                  ...
                  <div className='sm:col-span-3'>
                    ...
                    <TextAreaField
                      ...
                      handleBlur={formik.handleBlur}
                      value={
                        formik.values[schema.fields.description.attributes.name]
                      }
                      rows={5}
                    />
                    <ErrorField
                      error={
                        formik.errors[schema.fields.description.attributes.name]
                      }
                      touched={
                        formik.touched[
