          ...
          <main className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-20'>
            <div className='relative  border-orange-500 bg-white shadow-xl md:rounded-2xl md:border'>
              <div className='grid grid-cols-1 lg:grid-cols-3'>
                ...
                >
                  ...
                  <dl className={"space-y-4"}>
                    ...
                    <dd className='flex text-base text-indigo-50'>
                      ...
                      <span className='ml-3'>
                        Let us take care of the rest so you can have some peace
                        of mind that you are doing all that you can to bring
                    ...
                    <dd className='flex text-base text-indigo-50'>
                      ...
                      <span className='ml-3'>
                        Fill out our grant-report form to show how your grant
                        has helped the pets in your care.
                      </span>
                    </dd>
                    <dt>
                      <span className='text-lg font-medium text-slate-50'>
                    ...
                    <dd className='flex text-base text-indigo-50'>
                      ...
                      <span className='ml-3'>
                        Reach out to us with any questions you may still have.
                        We're here to help and do what we can to reunite you
                        with your lost dog or cat
                      </span>
                    </dd>
                ...
                {/* ------------------------------------------------ */}
                <section
                  className={"my-16 mx-5 rounded-2xl bg-white md:col-span-2"}
                >
                  ...
                  >
                    ...
                    <div className=''>
                      ...
                      <TextField
                        ...
                        value={
                          formik.values[schema.fields.name.attributes.name]
                        }
                      />
                      <ErrorField
                        error={
                          formik.errors[schema.fields.name.attributes.name]
                        }
                        touched={
                          formik.touched[schema.fields.name.attributes.name]
                        }
                      />
                    </div>
                    <div className=''>
                      ...
                      <TextField
                        ...
                        handleBlur={formik.handleBlur}
                        value={
                          formik.values[schema.fields.breed.attributes.name]
                        }
                      />
                      <ErrorField
                        error={
                          formik.errors[schema.fields.breed.attributes.name]
                        }
                        touched={
                          formik.touched[schema.fields.breed.attributes.name]
                        }
                      />
                    </div>
                    ...
                    <div className=''>
                      ...
                      <TextField
                        ...
                        handleBlur={formik.handleBlur}
                        value={
                          formik.values[schema.fields.color.attributes.name]
                        }
                      />
                      <ErrorField
                        error={
                          formik.errors[schema.fields.color.attributes.name]
                        }
                        touched={
                          formik.touched[schema.fields.color.attributes.name]
                        }
                      />
                    </div>
                    ...
                    <div className=''>
                      ...
                      <ErrorField
                        ...
                        touched={
                          formik.touched[schema.fields.age.attributes.name]
                        }
                      />
                    </div>
                    ...
                    <div className=''>
                      ...
                      <ErrorField
                        error={
                          formik.errors[schema.fields.collar.attributes.name]
                        }
                        touched={
                          formik.touched[schema.fields.collar.attributes.name]
                        }
                      />
                    </div>
                    ...
                    <div className=''>
                      ...
                      <ErrorField
                        error={
                          formik.errors[schema.fields.size.attributes.name]
                        }
                        touched={
                          formik.touched[schema.fields.size.attributes.name]
                        }
                      />
                    </div>
                    ...
                    <div className='sm:col-span-3'>
                      ...
                      <TextAreaField
                        ...
                        value={
                          formik.values[
                            schema.fields.description.attributes.name
                          ]
                        }
                        rows={5}
                      />
