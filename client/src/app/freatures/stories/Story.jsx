  ...
  return pet ? (
    ...
    >
      <div className="w-full sm:w-1/3 h-80 sm:h-64 sm:min-w-[35%]">
        <img
          className="rounded-tl-lg rounded-bl-lg h-full w-full object-fill flex-grow"
          src={pet.photo_url}
          alt="pet-image"
        />
      </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-4 mr-3">
            ...
            <div className="relative rounded-full bg-slate-50">
              ...
              <div className="absolute -top-3 left-3 px-2 py-1 text-xs font-bold leading-none text-red-100 transform bg-red-600 rounded-full">
                2033
              </div>
            </div>
