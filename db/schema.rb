...
ActiveRecord::Schema[7.0].define(version: 2023_01_12_163655) do
  ...
  create_table "pets_likes", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "pet_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pet_id"], name: "index_pets_likes_on_pet_id"
    t.index ["user_id"], name: "index_pets_likes_on_user_id"
  end
  ...
  add_foreign_key "pets_likes", "pets"
  add_foreign_key "pets_likes", "users"
